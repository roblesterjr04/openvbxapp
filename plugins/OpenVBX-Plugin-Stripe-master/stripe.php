...
if(count($_POST))
	PluginData::set('settings', array(
		...
		'amount_prompt' => $_POST['amount_prompt']
	));
$settings = PluginData::get('settings', array(
	...
	'amount_prompt' => "Please enter the amount to pay. For example, if you want to pay $20.50, enter 2 0 5 0 on the keypad, followed by the pound sign."
));
	...
	<div class="vbx-table-section vbx-stripe">
		<form method="post" action="">
			<fieldset class="vbx-input-container">
				...
				<p>
					<label class="field-label">Amount Prompt<br/>
						<textarea rows="10" cols="100" name="amount_prompt" class="medium"><?php echo htmlentities($settings['amount_prompt']); ?></textarea>
					</label>
				</p>
